...
class PoseNetNoBetaModel(BaseModel):
    def name(self):
        return 'PoseNetNoBetaModel'
    ...
    def initialize(self, opt):
        ...
        self.netG = networks.define_G(opt.input_nc, None, None, opt.which_model_netG, opt.sx, opt.sq,
    ...
    def backward_G(self):
        ...
        print(self.netG.learning_beta[0][0].item())
        print(self.netG.learning_beta[0][1].item())
        print(self.netG.learning_beta[1][0].item())
        print(self.netG.learning_beta[1][1].item())
        print(self.netG.learning_beta[2][0].item())
        print(self.netG.learning_beta[2][1].item())
        
        for l, learning_beta in enumerate(self.netG.learning_beta):
            ...
            self.loss_G += loss_weights[l] * ((-learning_beta[0]).exp() * mse_pos + learning_beta[0] + (-learning_beta[1]).exp() * mse_ori + learning_beta[1])
