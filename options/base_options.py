...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--sequence_length', type=int, default=15, help='# of images in a sequence')
        self.parser.add_argument('--overlap_step', type=int, default=1, help='steps between two consecutive sequences')                         
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='posenet', help='selects model to use for netG')
        ...
        self.parser.add_argument('--model', type=str, default='posenet', help='chooses which model to use. posenet')
